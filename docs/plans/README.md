...
| -------------------------------------------------------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [GPUI UI Fidelity](gpui-ui-fidelity-plan.md)                                                      | Active  | Core shell and feature parity are implemented; this pass synchronizes the latest Electron product contracts and completes final visual QA.                                  |
...
| [Compaction](compaction-plan.md)                                                                   | Partial | Pi-native semantic checkpoints now ship; durable memory, summary validation, provider-native paths, and measured rollout tuning remain open.                                 |
